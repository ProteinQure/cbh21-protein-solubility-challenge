...
path  = r'C:\Users\Kai Armstrong\PycharmProjects\cbh21-protein-solubility-challenge-main\cbh21-protein-solubility-challenge-main\data\training\crystal_structs'
...
df = df.transpose()
df.to_csv('proteins_training.csv', index=False)
